        ...
        {tasks.map((task) => (
          ...
          >
            ...
            <div className="flex justify-between items-start mb-5">
              <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest ${task.priority === 'High' ? 'bg-[#EF4444]/20 text-[#EF4444]' :
              task.priority === 'Medium' ? 'bg-[#F59E0B]/20 text-[#F59E0B]' : 'bg-[#10B981]/20 text-[#10B981]'
              }`}>
              <span className={`w-1.5 h-1.5 rounded-full animate-pulse ${task.priority === 'High' ? 'bg-[#EF4444]' :
